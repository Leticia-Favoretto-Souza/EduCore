                    ...
                    <div class="form-section">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select class="form-control" id="nivelEnsino" required onchange="mostrarAnosEscolares()">
                            ...
                            <div class="col-md-6" id="anoEscolarContainer" style="display: none;">
                                ...
                                <select class="form-control" id="anoEscolar" required>
                    ...
                    <div id="responsavel-section" class="form-section" style="display: none;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="rgResponsavel" placeholder="00.000.000-0">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" id="telefoneResponsavel" placeholder="(00) 00000-0000">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="emailResponsavel">E-mail</label>
                                <input type="email" class="form-control" id="emailResponsavel" placeholder="exemplo@email.com">
                            </div>
                        </div>
                    </div>
