...
<body>
                ...
                <div class="col-md-6">
                    <div class="card course-card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="inscricao_formulario.php" class="btn btn-primary-custom w-100">Quero me inscrever</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <a href="inscricao_formulario.php" class="btn btn-primary-custom btn-lg px-5">
